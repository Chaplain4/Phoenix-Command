...
class CombatSimulator:
    ...
    @staticmethod
    def _check_elevation_and_calculate_hits(
        eal: int,
        exposure: TargetExposure,
        weapon: Weapon,
        arc_of_fire: float
    ...
    @staticmethod
    def _check_shotgun_burst_elevation_and_get_hits(
        shooter: Character,
        target: Character,
        weapon: Weapon,
        range_hexes: int,
        ...
        return CombatSimulator._check_elevation_and_calculate_hits(eal, exposure, weapon, arc_of_fire)

    @staticmethod
    def _process_shotgun_pattern(
        ammo: AmmoType,
        targets: List[Character],
        ranges: List[int],
        exposures: List[TargetExposure],
    ...
    @staticmethod
    def _check_burst_elevation_and_get_hits(
        shooter: Character,
        target: Character,
        weapon: Weapon,
        range_hexes: int,
    ...
    def shotgun_shot(
        ...
        results = CombatSimulator._process_shotgun_pattern(
    ...
    def burst_fire(
        ...
        sab_penalty, arc_of_fire = CombatSimulator._setup_burst_fire(
        ...
        for idx, (target, rng, exposure, shot_params, front) in enumerate(zip(
            ...
            result = CombatSimulator._check_burst_elevation_and_get_hits(
        ...
        for idx, hits, target, rng, exposure, shot_params, front in target_hits:
            results = CombatSimulator._process_target_hits(
    ...
    def shotgun_burst_fire(
        ...
        for idx, (target, rng, exposure, params, front) in enumerate(
            ...
            data = CombatSimulator._get_shotgun_data_at_range(ammo, rng)
            
            result = CombatSimulator._check_shotgun_burst_elevation_and_get_hits(
        ...
        pattern_hits = CombatSimulator._redistribute_hits_by_eal(
        ...
        for primary_idx, patterns, target, rng, exposure, params, front in pattern_hits:
            ...
            for _ in range(patterns):
                pattern_result = CombatSimulator._process_shotgun_pattern(
